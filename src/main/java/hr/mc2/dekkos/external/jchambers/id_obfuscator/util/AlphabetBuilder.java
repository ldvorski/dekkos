package hr.mc2.dekkos.external.jchambers.id_obfuscator.util;
...
/**
 * Constructs alphabets for use with a {@link hr.mc2.dekkos.external.jchambers.id_obfuscator.AlphabetCodec}. Alphabet builders are not
 * thread-safe, and should generally be considered "single-shot" tools for constructing
 * {@link hr.mc2.dekkos.external.jchambers.id_obfuscator.AlphabetCodec} instances.
 *
...
public class AlphabetBuilder {
    ...
    private final List<Character> additionalIncludedCharacters = new ArrayList<>();
    private final List<Character> additionalExcludedCharacters = new ArrayList<>();
